...
<div align="center">
  ...
  <p align="center">
    <a href="https://galaxy.ansible.com/professormanhattan/androidstudio" alt="View the [[ package.json .blueprint.name - See CONTRIBUTING.md ]] role on Ansible Galaxy" target="_blank">
    ...
    <a href="repository.github" title="Version: null" target="_blank">
    ...
    <a href="repository.github/actions/Windows.yml" title="Windows build status" target="_blank">
      <img alt="Windows 10 build status" src="https://img.shields.io/github/workflow/status/ProfessorManhattan/repository.prefix.githubandroidstudio/Windows/master?color=cyan&label=Windows%20build&logo=windows&style=flat">
    </a>
    ...
    <a href="https://galaxy.ansible.com/professormanhattan/androidstudio" title="Number of downloads" target="_blank">
      <img alt="Ansible Galaxy downloads" src="https://img.shields.io/ansible/role/d/ansible_galaxy_project_id?logo=ansible&style=flat">
    </a>
    <a href="https://megabyte.space/docs/ansible" title="View documentation" target="_blank">
      <img alt="Documentation" src="https://img.shields.io/badge/documentation-yes-brightgreen.svg?logo=readthedocs&style=flat" />
    </a>
    <a href="repository.github/blob/master/LICENSE" title="View the license agreement" target="_blank">
    ...
    <a href="https://github.com/ProfessorManhattan" title="Follow ProfessorManhattan on GitHub" target="_blank">
      <img alt="GitHub: Megabyte Labs" src="https://img.shields.io/github/followers/ProfessorManhattan?style=social" target="_blank" />
    </a>
    <a href="https://twitter.com/MegabyteLabs" title="Follow MegabyteLabs on Twitter" target="_blank">

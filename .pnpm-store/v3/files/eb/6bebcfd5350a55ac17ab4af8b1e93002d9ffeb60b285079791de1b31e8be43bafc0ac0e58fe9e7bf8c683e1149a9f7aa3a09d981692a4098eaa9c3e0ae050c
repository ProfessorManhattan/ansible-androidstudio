...
function* getNextElements(start, dir) {
    let element = start;
    for (;;) {
...
function tryFindContradictionIn(element, dir, condition) {
...
function tryFindContradictionInAlternative(alternative, dir, condition) {

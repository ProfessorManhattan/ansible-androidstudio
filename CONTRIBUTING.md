...
- [➤ Installs Docker Compose if the `docker_install_compose` variable is set to true.](#-installs-docker-compose-if-the-docker_install_compose-variable-is-set-to-true)
  _ [Example Action Comment Generated Output](#example-action-comment-generated-output)
